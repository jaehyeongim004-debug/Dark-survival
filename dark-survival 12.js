...
/* Lobby */
#lobbyScreen{position:absolute;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,0.96);display:flex;flex-direction:column;align-items:center;justify-content:center;gap:12px;z-index:200;padding:20px;overflow-y:auto;pointer-events:all;}
...
#errMsg{color:#ff4444;font-size:13px;min-height:20px;text-align:center;font-weight:bold;background:#1a0000;padding:6px 12px;border-radius:4px;}

/* Class Select */
#classScreen{position:absolute;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,0.96);display:none;flex-direction:column;align-items:center;justify-content:center;gap:14px;z-index:200;padding:20px;overflow-y:auto;pointer-events:all;}
...
.classCard{background:#0a0a1a;border:1px solid #2a2a3a;border-radius:10px;padding:14px 16px;cursor:pointer;touch-action:manipulation;pointer-events:all;transition:border-color .15s,background .15s;display:flex;align-items:center;gap:14px;min-height:60px;}
...
/* Level up */
#lvlUpScreen{position:absolute;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,0.85);display:none;flex-direction:column;align-items:center;justify-content:center;gap:14px;z-index:200;padding:20px;}
...
/* Stage clear */
#stageClearScreen{position:absolute;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,0.88);display:none;flex-direction:column;align-items:center;justify-content:center;gap:14px;z-index:200;}
...
/* Game Over */
#goScreen{position:absolute;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,0.92);display:none;flex-direction:column;align-items:center;justify-content:center;gap:10px;z-index:200;pointer-events:all;}
...
function connect(cb){
  ...
  try{
    ...
    ws.onerror=(e)=>{showErr('❌ 서버 연결 실패 - 새로고침 해주세요');console.error('WS error',e);};
    ws.onclose=(e)=>{if(!myId){showErr('❌ 연결 끊김 ('+e.code+') - 새로고침 해주세요');console.warn('WS closed',e.code,e.reason);}};
  }catch(err){showErr('❌ WebSocket 오류: '+err.message);}
}
