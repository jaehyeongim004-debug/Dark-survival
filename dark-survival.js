...
function tickRoom(code) {
  ...
  if (room.boss && !room.boss.dead) {
    ...
    if (room.patT > patInterval) {
      ...
      bcastAll(room, { t: 'pat', i: (room.patI || 0) % patCount, bx: b.x, by: b.y, ang: b.ang, phase: b.phase, stage: room.currentStage });
    ...
    if (b.isFinal && b.phase === 2) {
      ...
      if (room.extraPatT > 2.5) {
        room.extraPatT = 0;
        bcastAll(room, { t: 'pat', i: 1, bx: b.x, by: b.y, ang: b.ang + Math.PI / 4, phase: 2, stage: room.currentStage });
      }
    }
  }
