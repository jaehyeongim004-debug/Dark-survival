...
if(wasGroggy&&!me.groggy&&!me.dead){running=true;} // 부활 시 running 복구
...
function bcast(room,msg,except){const d=JSON.stringify(msg);room.players.forEach((*,ws)=>{if(ws!==except&&ws.readyState===1)ws.send(d);});}
